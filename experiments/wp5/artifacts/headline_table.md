...
| GL (Gödel-Löb provability logic) | resolved by ascent | a strictly higher consistency level (Con_n ⊊ Con_{n+1}) | [E-A2](experiments/wp3/artifacts/ladder_manifest.json) — stages 0..8, every stage's monotone direction proved and strict direction refuted, witness counts [2, 3, 4, 5, 6, 7, 8, 9, 10] (linear n+2); minimality exhaustively verified for n ∈ [0, 1, 2, 3, 4] | unbounded (each stage requires a strictly deeper frame; linear n+2) |
